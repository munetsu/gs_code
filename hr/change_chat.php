<?php
    ...
    // タスクデータ取得
    $sql = "SELECT * FROM task_table INNER JOIN user_table ON task_table.recipient_id = user_table.id WHERE task_id = $task_id";
        ...
        <div class="rightarea">
            ...
            <div class="main">
                ...
                <div class="todo">
                    ...
                    <div class="itemarea">
                        <p class="item">評価：</p>
                        <form method="post" action="change_task_update.php">
                            ...
                            <div class="finish">
                                ...
                                <input type="submit" class="finishbtn" value="完了">
                            </div>
                        </form>
                    </div>
...
firebase.initializeApp(config);
    ...
    <script src="js/change_firebase.js"></script>
</body>
</html>